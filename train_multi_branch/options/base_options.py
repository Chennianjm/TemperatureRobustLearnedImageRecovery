...
class BaseOptions():
	...
	def initialize(self):
		...
		self.parser.add_argument('--loadSizeX', type=int, default=3491, help='3666 scale images to this size')
		self.parser.add_argument('--loadSizeY', type=int, default=2346, help='2421 scale images to this size')
		...
		self.parser.add_argument('--learn_residual', default=True, action='store_true', help='learn the residual to the input')
		...
		self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2 use -1 for CPU')
		self.parser.add_argument('--name', type=str, default='LFOV', help='name of the experiment. It decides where to store samples and models')
		...
		self.parser.add_argument('--layers', type=int, default=6, help='the nums of the layers of the U-net')
