...
class TrainOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--off_axis', default=False, help='off axis field')
		self.parser.add_argument('--tensorboard_root', default='.\\tensorboard\\log', help='tensorboard_save')
		self.isTrain = True
