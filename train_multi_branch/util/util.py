...
def save_image(image_numpy, image_path):
    ...
    if image_numpy.shape[2] == 1:
        ...
        image_numpy = image_numpy**(1)  # gamma

        gamma = np.zeros(image_numpy.shape)
        gamma[image_numpy > 0.0031308] = 1.055 * image_numpy[image_numpy > 0.0031308] ** (1 / 2.4) - 0.055
        gamma[image_numpy < 0.0031308] = 12.92 * image_numpy[image_numpy < 0.0031308]
        image_numpy = gamma
        #
